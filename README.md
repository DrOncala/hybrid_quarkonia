...
This repository contains MATLAB codes to solve the **spectrum** and **wavefunctions** of quarkonium and hybrid states through numerical solutions of the Schrödinger equation. Our results in the reference are in the [`output`](./output/)  folder.
...
- **`shrodinger`**  
  Folder with **numerical methods** used to compute the **eigenvalues** and **eigenfunctions** of the Schrödinger equations including the treatment of **matrix (m×m) dimension potentials** with **non-diagonal coupling terms**.  
...
Cite all versions? You can cite all versions by using the

[![DOI](https://zenodo.org/badge/1090599228.svg)](https://doi.org/10.5281/zenodo.17564180)
