...
|:------|:-------------------|:---------------|:-------------|
| **H1** | $P^\pm_J$ (Ppm) | $n(s/d)_1$, $n(p/f)_2$, ... | Coupled hybrid (J > 0, J = L ± 1) with $Π_u$ and $Σ_u⁻$ potentials |
| **H2** | $P^0_J$ (P0) | $np_1$, $nd_2$, ... | Decoupled hybrid ($J > 0$, $J = L$) with $Π_u$ potential |
| **H3** | $P^+_0$ (Pplus0) | $np_0$ | Decoupled hybrid (J = 0) with $Σ_u⁻$ potential |
