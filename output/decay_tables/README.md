...
| **⟨i r f⟩ or ⟨i f⟩** | Radial or wave-function overlap integral between initial and final wave functions, without angular coefficients | GeV⁻¹ |
| **⟨H r S⟩ or ⟨H S⟩** | Radial  or wave-function overlap integral between initial and final wave functions, with angular coefficients | GeV⁻¹ |
...
| **rel.1** | First relativistic correction term: $ΔE / 16 m_Q$ | dimensionless |
